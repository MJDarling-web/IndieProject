...
<main class="landing-page">
    ...
    <section class="hero-section">
        ...
        <div class="hero-actions">
            ...
            <a href="${empty sessionScope.userName ? 'logIn' : 'comparisonCost'}" class="btn btn-outline">View Analytics</a>
        </div>
    </section>
    ...
    <section class="feature-cards">
        ...
        <div class="feature-card">
            ...
            <a href="${empty sessionScope.userName ? 'logIn' : 'saveVehicleProfile'}" class="feature-link">Learn More</a>
        </div>
        ...
        <div class="feature-card">
            ...
            <a href="${empty sessionScope.userName ? 'logIn' : 'comparisonCost'}" class="feature-link">Learn More</a>
        </div>
    </section>
    ...
    <section class="value-section">
        <div class="value-item">
            <div class="value-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ff6b35" class="bi bi-check-circle" viewBox="0 0 16 16">
        ...
        <div class="value-item">
            <div class="value-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ff6b35" class="bi bi-graph-up" viewBox="0 0 16 16">
        ...
        <div class="value-item">
            <div class="value-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ff6b35" class="bi bi-file-earmark-medical" viewBox="0 0 16 16">
